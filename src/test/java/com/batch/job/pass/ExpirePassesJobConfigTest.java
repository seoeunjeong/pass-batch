...
import com.batch.job.pass.expirePasses.ExpirePassesJobConfig;
...
import static com.batch.entity.pass.PassStatus.*;
...
@SpringBatchTest
@ActiveProfiles("test")
@Import(ExpirePassesJobConfig.class)
class ExpirePassesJobConfigTest {
    ...
    private void addPassEntities(int size) {
        ...
        for (int i = 0; i < size; ++i) {
            ...
            Object PassStatus;
            passEntity.setStatus(IN_PROGRESS);
