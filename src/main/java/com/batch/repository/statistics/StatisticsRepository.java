package com.batch.repository.statistics;


import com.batch.entity.statistics.StatisticsEntity;
...
public interface StatisticsRepository extends JpaRepository<StatisticsEntity, Integer> {
    ...
    @Query(value = "SELECT new com.batch.repository.statistics.AggregatedStatistics(s.statisticsAt, SUM(s.allCount), SUM(s.attendedCount), SUM(s.cancelledCount)) " +
